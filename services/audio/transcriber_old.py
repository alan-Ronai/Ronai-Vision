...
class HebrewTranscriber:
    ...
    def _lazy_load(self):
        ...
        try:
            ...
            self.model = WhisperForConditionalGeneration.from_pretrained(
                ...
                torch_dtype=torch.float32 if self.compute_type == "float32" else torch.float16,
    ...
    def transcribe(
        ...
        try:
            ...
            with torch.no_grad():
                # Use language and task parameters directly (new API)
    ...
    def transcribe_file(self, audio_path: str, language: str = "he") -> Dict[str, Any]:
        ...
        try:
            ...
            for i in range(0, len(audio), chunk_samples):
                ...
                logger.info(
                    f"Processing chunk {i // chunk_samples + 1} (starting at {chunk_start_time:.1f}s)"
                )
            ...
            logger.info(
                f"Transcription complete: {len(segments)} segments, {total_duration:.2f}s total"
            )
